                    ...
                    {isOnline && feedStatus && Object.values(feedStatus).some(Boolean) && (
                      <>
                        ...
                        <span className="flex items-center gap-1" title="Live real-time feeds active">
                          {(feedStatus['groww-in-stream'] || feedStatus['yahoo-in-stream']) && <span className="px-1 rounded bg-emerald-500/15 text-emerald-400 text-[9px] font-bold font-mono">NSE⚡</span>}
