...
// v13.5 (full-site recheck): enhanceDipSignalWithML + enhanceAllDipsWithML
// deleted — zero call sites (the dip ML-enhancement subsystem was never
// wired; MLSignalPanel calls fetchMLPrediction directly). The
// fetchMLPrediction import went with it.
