      ...
      <AnimatePresence>
        {showChat && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 left-4 sm:left-auto sm:right-6 sm:w-[400px] h-[600px] max-h-[80vh] shadow-[0_0_50px_rgba(6,182,212,0.1)] z-[60] flex flex-col overflow-hidden"
          >
            ...
            <div className="relative flex-1 overflow-y-auto p-5 space-y-6 scrollbar-hide">
              {chatMessages.map((msg, i) => (
                <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[85%] p-4 rounded-2xl text-sm leading-relaxed whitespace-pre-line ${msg.role === 'user'
