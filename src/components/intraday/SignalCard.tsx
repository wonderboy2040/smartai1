// ============================================================
// intraday/SignalCard — pro-desk signal card (v3)
// ------------------------------------------------------------
// Upgrades over v2:
//   • LIVE LTP from the SSE stream (flash tick, 5s cadence)
//   • SL↔T2 proximity meter — "kitna door/paas hai" at a glance
//   • Sector badge + counter-regime warning
//   • NO-FRESH-ENTRY state after 15:00 IST
    ...
    <div className={`quantum-panel rounded-2xl p-4 border ${long ? 'border-emerald-500/25 bg-gradient-to-b from-emerald-500/[0.04] to-transparent' : 'border-red-500/25 bg-gradient-to-b from-red-500/[0.04] to-transparent'} relative overflow-hidden flex flex-col justify-between gap-3 shadow-lg shadow-black/20`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title={paperOpenForSymbol ? 'Virtual trade already open' : noFresh ? 'Fresh entries blocked after 15:00 IST' : 'Open a virtual (paper) trade with these levels'}
        >
